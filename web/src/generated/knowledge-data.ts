...
export const knowledgeChunks: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    "docId": "content/tech/tools/knowledge-base-workflow",
    "heading": "评论和反馈的区别",
    "text": "简单判断： - 想讨论：用评论。 - 想推动修改：用反馈。",
    "searchText": "知识库使用与反馈流程 评论和反馈的区别 简单判断： - 想讨论：用评论。 - 想推动修改：用反馈。"
  },
  {
